      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- ============================================================== -->
            ...
            <div class="card">
              <form class="form-horizontal" method="POST" action="add-visit.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select type="text" class="form-control" name="statusofvisit" >
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="remarks" placeholder="Remarks Here" />
                        </div>
                      </div>
                    </div>
